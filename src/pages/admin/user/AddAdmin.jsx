...
import { postNewAdmin } from "../../../store/nguoiDung/nguoiDungReducer";
          ...
          <div className="border rounded-md w-full p-3 mb-3">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className=" w-full mb-3">
                <div className="w-full text-lg font-semibold mb-1">Role</div>
                <div className="flex w-full items-center">
                  <select className="px-4 py-2" {...register("role")}>
